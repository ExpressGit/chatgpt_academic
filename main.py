...
def main():
    ...
    title_html = f"<h1 align=\"center\">三哥up ChatGPT 学术优化 {get_current_version()}</h1>"
    ...
    cancel_handles = []
    with gr.Blocks(title="三哥 up ChatGPT 学术优化", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
